  ...
  useEffect(() => {
    ...
    Promise.allSettled([
      ...
      .then(results => {
        ...
        setData({
          ...
          journey:
            journeyResult.status === 'fulfilled'
              ? Array.isArray(journeyResult.value)
                ? journeyResult.value
                : []
              : [],
        ...
        // Helpful diagnostics without breaking the UI.
        results.forEach((result, index) => {
          if (result.status === 'rejected') {
            ...
            console.warn(
              `Portfolio API unavailable: ${endpoints[index]}`,
              result.reason
            );
          }
        });
  ...
  useEffect(() => {
    ...
    api.get('/health')
      .then(result => {
        ...
        setStatus({
          system: 'ONLINE',
          api: result?.status === 'ok' ? 'ONLINE' : 'ONLINE'
        });
      })
      .catch(error => {
    ...
    >
      ...
      <div className="hero-copy">
        ...
        <p
          ...
          data-reveal
        >
          I build modern, interactive web
          applications and practical AI-powered
          systems, from considered frontend
          experiences to connected backend
          architecture.
        </p>
...
function About({
  ...
  return (
    ...
    >
      <SectionLabel
        number="01"
        title="A developer with a systems mind."
      ...
      <div className="about-layout">
        ...
        >
          <p>
            ...
            and practical AI-powered systems.
            I enjoy turning ideas into working
            products — from polished frontend
            experiences to connected backend
            systems and APIs.
          </p>

          <p className="muted">
            Driven by curiosity, experimentation,
            and technology that solves real
            problems.
          </p>
        </div>
...
function Stack({
  ...
  return (
    ...
    >
      <SectionLabel
        number="02"
        title="Tools for making ideas real."
        intro="STACK / WORKING SET"
      />
...
// Deterministic abstract technical visual.
// Used instead of stock or invented screenshots.
function ProjectVisual({
  ...
  return (
    <svg
      className={`project-visual-svg ${size}`}
      viewBox="0 0 240 140"
      aria-hidden="true"
    >
      <rect
    ...
    >
      ...
      >
        ...
        <div className="case-grid">
          <div>
            ...
            <p>
              {project.solution ||
                project.details ||
                'A practical system designed to turn a complex problem into a more useful, understandable experience.'}
            </p>
        ...
        <div className="case-actions">
          ...
          <button
            className="text-link next-project"
            onClick={onNext}
          >
            Next project ↗
          </button>
...
function EngineeringLab({
  ...
  return (
    <section
      id="lab"
      className="section engineering-lab"
    >
      <SectionLabel
        number="05"
        title="Small experiments, kept alive."
...
function CurrentBuild({
  ...
  return (
    <section className="section current-build">
      <SectionLabel
        number="07"
        title="Currently making KisanSeva."
        intro="NOW / ACTIVE BUILD"
      />
...
function Philosophy() {
  return (
    <section className="section philosophy">
      <SectionLabel
        number="08"
        title="The reason behind the work."
        intro="PHILOSOPHY / PRINCIPLE"
      />

      <div
        className="philosophy-principles"
        data-reveal
      >
        <span>
          USEFUL <em>&gt;</em>{' '}
      ...
      <div
        ...
        data-reveal
      >
        I don't build software just
        because it can be built.{' '}
        <em>
          I build because technology
          should make complex problems
          easier to understand — and real
...
function Terminal({
  ...
  const handlers = {
    help: () =>
      'help · whoami · about · projects · skills · stack · journey · status · build · contact · clear\naliases: ls, pwd, cat about.txt',
    ...
    projects: () =>
      projects
        .map(
          project =>
            `0${project.number} · ${project.name} [${project.status}]`
        )
        .join('\n'),
    ...
    journey: () =>
      'Type "help" to see other commands, or scroll to the Journey section.',
